...
public class SpringMvcController {
	 ...
	 //@RequestMapping이 붙은 메소드가 실행되기전에 @ModelAttribute메소드가
	...
	public String requestParam(@RequestParam(name = "userId")String userId, 
...
//		model.addAttribute("userId", userId);
		...
		//redirect시 최초 1회에 한해 해당 속성값을 유지하고, 읽혀지면
		//자동적으로 세션에서 해당 속성을 제거한다.
	...
	public String responseStatus() throws NoFileException {
		...
		//인위적으로 존재하지 않는 파일에 접근하며
		//IOException이 발생하도록 작성
		//IOExceptiondmf catch 하여 우리가 작성한 NoFileException으로 새롭게 예외 throw
	...
	public String ioException(String fileInfo) throws ServerErrorException {
