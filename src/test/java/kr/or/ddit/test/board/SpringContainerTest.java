...
//@Test 메소드가 실행되기전에 제공한 조립 설명서를 바탕으로 스프링 컨테이너 구축
...
public class SpringContainerTest {
	...
	//name : 스프링 빈 이름
	//boardService라는 이름의 스프링 빈을 스프링 컨테이너로부터 찾아
	//boardService 필드에 주입
